...
public class Track {
   ...
   */
  @JsonAdapter(MaxChannelLayoutEnum.Adapter.class)
  public enum MaxChannelLayoutEnum {
    MONO("mono"),
    ...
    MaxChannelLayoutEnum(String value) {
      this.value = value;
    }
    ...
    public static MaxChannelLayoutEnum fromValue(String value) {
      for (MaxChannelLayoutEnum b : MaxChannelLayoutEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<MaxChannelLayoutEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final MaxChannelLayoutEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public MaxChannelLayoutEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return MaxChannelLayoutEnum.fromValue(value);
      }
    }
  }
  ...
  private MaxChannelLayoutEnum maxChannelLayout;
  ...
  **/
  ...
  public Track maxChannelLayout(MaxChannelLayoutEnum maxChannelLayout) {
  ...
  **/
  ...
  public MaxChannelLayoutEnum getMaxChannelLayout() {
    return maxChannelLayout;
  }


  public void setMaxChannelLayout(MaxChannelLayoutEnum maxChannelLayout) {
    this.maxChannelLayout = maxChannelLayout;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Arbitrary metadata set for the track either when creating the asset or track. This parameter is set for `text` type and `subtitles` text type track. Max 255 characters.")
