...
public class CreateTrackRequest {
  ...
  **/
  ...
  @ApiModelProperty(value = "The name of the track containing a human-readable description. This value must be unqiue across all the text type and subtitles text type tracks. HLS manifest will associate subtitle text track with this value. For example, set the value to \"English\" for subtitles text track with language_code as en-US. If this parameter is not included, Mux will auto-populate based on the language_code value.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Arbitrary metadata set for the track either when creating the asset or track.")
