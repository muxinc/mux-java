...
public class ListRealTimeMetricsResponse {
  ...
  public ListRealTimeMetricsResponse data(java.util.List<ListRealTimeDimensionsResponseData> data) {
    
    this.data = data;
    return this;
  }

  public ListRealTimeMetricsResponse addDataItem(ListRealTimeDimensionsResponseData dataItem) {
    if (this.data == null) {
