...
public class GetMetricTimeseriesDataResponse {
  ...
  public GetMetricTimeseriesDataResponse addDataItem(java.util.List<String> dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public GetMetricTimeseriesDataResponse timeframe(java.util.List<Long> timeframe) {
