...
public class Asset {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The duration of the asset in seconds (max duration for a single asset is 24 hours).")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createdAt, status, duration, maxStoredResolution, maxStoredFrameRate, aspectRatio, playbackIds, tracks, errors, perTitleEncode, isLive, passthrough, liveStreamId, master, masterAccess, mp4Support, sourceAssetId, normalizeAudio, staticRenditions, recordingTimes, nonStandardInputReasons, test);
  }
