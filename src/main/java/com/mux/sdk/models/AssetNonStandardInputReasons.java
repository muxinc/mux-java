...
public class AssetNonStandardInputReasons {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The video key frame Interval (also called as Group of Picture or GOP) of the input file is `high`. This parameter is present when the gop is greater than 20 seconds.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The video frame rate of the input file. Video with average frames per second (fps) less than 5 or greater than 120 is non-standard. A `-1` frame rate value indicates Mux could not determine the frame rate of the video track.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The video bitrate of the input file is `high`. This parameter is present when the average bitrate of any key frame interval (also known as Group of Pictures or GOP) is higher than what's considered standard which typically is 16 Mbps.")
